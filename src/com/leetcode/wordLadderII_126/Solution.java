package com.leetcode.wordLadderII_126;

import java.util.Arrays;
import java.util.List;

abstract public class Solution {
    abstract public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList);
    ...
    public static void main(String[] args) {
        ...
        for (Solution s : solutions) {
            ret = s.findLadders("cet", "ism", Arrays.asList("kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz",
                    "brr", "gay", "sip", "kay", "per", "val", "mes", "ohs", "now", "boa", "cet", "pal", "bar", "die",
            ...
            ret = s.findLadders("a", "c", Arrays.asList("a", "b", "c"));

            ret = s.findLadders("hit", "cog", Arrays.asList("hot", "dot", "dog", "lot", "log"));

            ret = s.findLadders("hit", "cog", Arrays.asList("hot", "dot", "dog", "lot", "log", "cog"));
        }
